...
- **Typography**: geometric sans for display, DM Sans for body. Specific display font still under iteration (Josefin Sans, Manrope, Space Grotesk, Jost, Inter, or unified-DM-Sans). All-caps labels with wide letter-spacing (≥0.18em) for editorial gravitas. Body stays highly legible, never all-caps, regular letter-spacing.
