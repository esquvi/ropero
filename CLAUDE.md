...
These are systemic. They apply to every page, not per-screen. See [PRODUCT.md](PRODUCT.md) for full context, [DESIGN.md](DESIGN.md) for the token + component reference, and [docs/brand/matcha.html](docs/brand/matcha.html) for visual reference.
